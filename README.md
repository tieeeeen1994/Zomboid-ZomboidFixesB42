...
- Speed controls are back in multiplayer. The game fast forwards once every player votes for it, and right-clicking a fast forward button makes your timed actions vote for that speed automatically once you have been busy for a few seconds (5 by default).
